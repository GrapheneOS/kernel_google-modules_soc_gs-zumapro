...
static void icl_work_item(struct kthread_work *work)
{
	...
	logbuffer_log(chip->log, "%s: psy: %s ONLINE:%d USB_TYPE:%d CURRENT_MAX:%d VOLTAGE_MAX:%d",
		      __func__, chip->tcpm_psy->desc->name, online.intval, usb_type.intval,
		      current_max.intval, voltage_max.intval);
