...
const int ADDRESS_AT[ADDRESS_COUNT][ID_COUNT] = {
	...
	[ADDRESS_ACC_DATA] = {
		...
		S2MPG15_METER_ACC_DATA_CH0_1
	},
	[ADDRESS_ACC_COUNT] = {
		S2MPG14_METER_ACC_COUNT_1,
		S2MPG15_METER_ACC_COUNT_1
	},
	[ADDRESS_LPF_MODE] = { S2MPG14_METER_CTRL6, S2MPG15_METER_CTRL6 },
	[ADDRESS_LPF_DATA] = {
		S2MPG14_METER_LPF_DATA_CH0_1,
		S2MPG15_METER_LPF_DATA_CH0_1
	},
};
						      ...
						      int num_bytes)
{
	...
	return s2mpg1415_bulk_write(id, i2c, ADDRESS_AT[ADDRESS_BUCKEN1][id],
				    num_bytes, channels);
}
...
static inline int s2mpg1415_meter_set_ext_channel_en(enum s2mpg1415_id id,
						     ...
						     u8 channels)
{
	return s2mpg1415_update_reg(id, i2c, ADDRESS_AT[ADDRESS_CTRL2][id],
...
{
	return s2mpg1415_update_reg(id, i2c, ADDRESS_AT[ADDRESS_CTRL1][id],
						      ...
						      u32 val)
{
	...
	return s2mpg1415_write_reg(id, i2c, ADDRESS_AT[ADDRESS_LPF_C0_0][id] +
				   ch, val);
}

static inline const u32 *s2mpg1415_meter_get_int_samping_rate_table(void)
{
	return s2mpg1415_int_sample_rate_uhz;
}

static inline const u32 *s2mpg1415_meter_get_ext_samping_rate_table(void)
{
	return s2mpg1415_ext_sample_rate_uhz;
}
					    ...
					    bool is_acc_mode)
{
	...
	case S2MPG1415_METER_POWER:
		s2mpg1415_write_reg(id, i2c, ADDRESS_AT[mode_addr][id], 0x00);
		s2mpg1415_update_reg(id, i2c, ADDRESS_AT[mode_addr][id] + 1,
				     0x00, /* mask= */ 0x0F);
		break;

	case S2MPG1415_METER_CURRENT:
		s2mpg1415_write_reg(id, i2c, ADDRESS_AT[mode_addr][id], 0xFF);
		s2mpg1415_update_reg(id, i2c, ADDRESS_AT[mode_addr][id] + 1,
				     0x0F, /* mask= */ 0x0F);
		break;
	}
