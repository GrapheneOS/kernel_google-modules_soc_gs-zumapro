...
#define LWIS_PLATFORM_EVENT_ID_GSE_CORE_FINISH \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_CORE_FINISH)
#define LWIS_PLATFORM_EVENT_ID_GSE_SCALER0_FINISH \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_SCALER0_FINISH)
#define LWIS_PLATFORM_EVENT_ID_GSE_SCALER1_FINISH \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_SCALER1_FINISH)
#define LWIS_PLATFORM_EVENT_ID_GSE_RAISR_FINISH \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_RAISR_FINISH)
#define LWIS_PLATFORM_EVENT_ID_GSE_WDMA0_FINISH \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_WDMA0_FINISH)
#define LWIS_PLATFORM_EVENT_ID_GSE_WDMA1_FINISH \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_WDMA1_FINISH)
#define LWIS_PLATFORM_EVENT_ID_GSE_ALL_FRAME_START \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_ALL_FRAME_START)
#define LWIS_PLATFORM_EVENT_ID_GSE_ALL_FRAME_DONE \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_ALL_FRAME_DONE)
#define LWIS_PLATFORM_EVENT_ID_GSE_PER_FRAME_START \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_PER_FRAME_START)
#define LWIS_PLATFORM_EVENT_ID_GSE_PER_FRAME_DONE \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_PER_FRAME_DONE)
#define LWIS_PLATFORM_EVENT_ID_GSE_CSR_COPY_DONE \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_CSR_COPY_DONE)
#define LWIS_PLATFORM_EVENT_ID_GSE_RDMA_ERR \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_RDMA_ERR)
#define LWIS_PLATFORM_EVENT_ID_GSE_WDMA0_ERR \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_WDMA0_ERR)
#define LWIS_PLATFORM_EVENT_ID_GSE_WDMA1_ERR \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_WDMA1_ERR)
#define LWIS_PLATFORM_EVENT_ID_GSE_RESERVE_AFBC_ENC0 \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_RESERVE_AFBC_ENC0)
#define LWIS_PLATFORM_EVENT_ID_GSE_RESERVE_AFBC_ENC1 \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_RESERVE_AFBC_ENC1)
#define LWIS_PLATFORM_EVENT_ID_GSE_AFBC_DEC \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_AFBC_DEC)
#define LWIS_PLATFORM_EVENT_ID_GSE_SBWC_DEC_LUMA \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_SBWC_DEC_LUMA)
#define LWIS_PLATFORM_EVENT_ID_GSE_SBWC_DEC_CHROMA \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_SBWC_DEC_CHROMA)
#define LWIS_PLATFORM_EVENT_ID_GSE_VOTF_LOST_CONNECTION \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_VOTF_LOST_CONNECTION)
#define LWIS_PLATFORM_EVENT_ID_GSE_VOTF_SLOW_RING \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_VOTF_SLOW_RING)
#define LWIS_PLATFORM_EVENT_ID_GSE_VOTF_LOST_FLUSH \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_VOTF_LOST_FLUSH)
#define LWIS_PLATFORM_EVENT_ID_GSE_OUT_STALL_TIMEOUT \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_OUT_STALL_TIMEOUT)
#define LWIS_PLATFORM_EVENT_ID_GSE_INPUT_FRAME_CRUSH \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_INPUT_FRAME_CRUSH)
#define LWIS_PLATFORM_EVENT_ID_GSE_INPUT_HOR_OVF \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_INPUT_HOR_OVF)
#define LWIS_PLATFORM_EVENT_ID_GSE_INPUT_HOR_UNF \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_INPUT_HOR_UNF)
#define LWIS_PLATFORM_EVENT_ID_GSE_INPUT_VER_OVF \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_INPUT_VER_OVF)
#define LWIS_PLATFORM_EVENT_ID_GSE_INPUT_VER_UNF \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_INPUT_VER_UNF)
#define LWIS_PLATFORM_EVENT_ID_GSE_ACTIVE_APB_WR_IN_MASK_CYCLE \
	EVENT_ID(GSE_IRQ_BASE, \
		 GSE_IRQ_ACTIVE_APB_WR_IN_MASK_CYCLE)

#define LWIS_PLATFORM_EVENT_ID_GSE_PDMA_ERR \
...
#define LWIS_PLATFORM_EVENT_ID_GSE_FABRIC_DEC_ERR \
	EVENT_ID(GSE_SEC_IRQ_BASE, \
		 GSE_SEC_IRQ_FABRIC_DEC_ERR)
#define LWIS_PLATFORM_EVENT_ID_GSE_FABRIC_SLV0_ERR \
	EVENT_ID(GSE_SEC_IRQ_BASE, \
		 GSE_SEC_IRQ_FABRIC_SLV0_ERR)
#define LWIS_PLATFORM_EVENT_ID_GSE_FABRIC_SLV1_ERR \
	EVENT_ID(GSE_SEC_IRQ_BASE, \
		 GSE_SEC_IRQ_FABRIC_SLV1_ERR)
#define LWIS_PLATFORM_EVENT_ID_GSE_FABRIC_SLV2_ERR \
	EVENT_ID(GSE_SEC_IRQ_BASE, \
		 GSE_SEC_IRQ_FABRIC_SLV2_ERR)
#define LWIS_PLATFORM_EVENT_ID_GSE_FABRIC_SLV3_ERR \
	EVENT_ID(GSE_SEC_IRQ_BASE, \
		 GSE_SEC_IRQ_FABRIC_SLV3_ERR)
#define LWIS_PLATFORM_EVENT_ID_GSE_FABRIC_SLV4_ERR \
	EVENT_ID(GSE_SEC_IRQ_BASE, \
		 GSE_SEC_IRQ_FABRIC_SLV4_ERR)
#define LWIS_PLATFORM_EVENT_ID_GSE_FABRIC_SLV5_ERR \
	EVENT_ID(GSE_SEC_IRQ_BASE, \
		 GSE_SEC_IRQ_FABRIC_SLV5_ERR)
#define LWIS_PLATFORM_EVENT_ID_GSE_FABRIC_SLV6_ERR \
	EVENT_ID(GSE_SEC_IRQ_BASE, \
		 GSE_SEC_IRQ_FABRIC_SLV6_ERR)
#define LWIS_PLATFORM_EVENT_ID_GSE_FABRIC_SLV7_ERR \
	EVENT_ID(GSE_SEC_IRQ_BASE, \
		 GSE_SEC_IRQ_FABRIC_SLV7_ERR)

#define LWIS_PLATFORM_EVENT_ID_GSE_IRQ_CMD \
	EVENT_ID(GSE_PDMA_BASE, \
		 GSE_PDMA_IRQ_CMD)
#define LWIS_PLATFORM_EVENT_ID_GSE_ALMOST_EMPTY \
	EVENT_ID(GSE_PDMA_BASE, \
		 GSE_PDMA_ALMOST_EMPTY)

#define LWIS_PLATFORM_EVENT_ID_GSE_MEM_BUS_ERR \
	EVENT_ID(GSE_PDMA_ERR_BASE, \
		 GSE_PDMA_ERR_MEM_BUS_ERR)
#define LWIS_PLATFORM_EVENT_ID_GSE_CSR_BUS_ERR \
	EVENT_ID(GSE_PDMA_ERR_BASE, \
		 GSE_PDMA_ERR_CSR_BUS_ERR)
#define LWIS_PLATFORM_EVENT_ID_GSE_ILLEGAL_CMD \
	EVENT_ID(GSE_PDMA_ERR_BASE, \
		 GSE_PDMA_ERR_ILLEGAL_CMD)
#define LWIS_PLATFORM_EVENT_ID_GSE_RECUR_INDIR_CMD \
	EVENT_ID(GSE_PDMA_ERR_BASE, \
		 GSE_PDMA_ERR_RECUR_INDIR_CMD)
#define LWIS_PLATFORM_EVENT_ID_GSE_CMD_SIZE_MISMATCH \
	EVENT_ID(GSE_PDMA_ERR_BASE, \
		 GSE_PDMA_ERR_CMD_SIZE_MISMATCH)

#define LWIS_PLATFORM_EVENT_ID_GSE_SW_RESET_DONE \
	EVENT_ID(GSE_PDMA_RSTCTL_BASE, \
		 GSE_PDMA_RSTCTL_SW_RESET_DONE)
#define LWIS_PLATFORM_EVENT_ID_GSE_INPUT_FLUSH_DONE \
	EVENT_ID(GSE_PDMA_RSTCTL_BASE, \
		 GSE_PDMA_RSTCTL_INPUT_FLUSH_DONE)
#define LWIS_PLATFORM_EVENT_ID_GSE_SW_MODE \
	EVENT_ID(GSE_PDMA_RSTCTL_BASE, \
		 GSE_PDMA_RSTCTL_SW_MODE)
#define LWIS_PLATFORM_EVENT_ID_GSE_APB_GKP_ERR \
	EVENT_ID(GSE_PDMA_RSTCTL_BASE, \
		 GSE_PDMA_RSTCTL_APB_GKP_ERR)
#define LWIS_PLATFORM_EVENT_ID_GSE_AXI_GKP_ERR \
	EVENT_ID(GSE_PDMA_RSTCTL_BASE, \
...
#define LWIS_PLATFORM_EVENT_ID_GSE_SLV0_ERR \
	EVENT_ID(GSE_CSR_BUS_WRAP_BASE, \
		 GSE_CSR_BUS_WRAP_SLV0_ERR)
#define LWIS_PLATFORM_EVENT_ID_GSE_SLV1_ERR \
	EVENT_ID(GSE_CSR_BUS_WRAP_BASE, \
		 GSE_CSR_BUS_WRAP_SLV1_ERR)
#define LWIS_PLATFORM_EVENT_ID_GSE_SLV2_ERR \
	EVENT_ID(GSE_CSR_BUS_WRAP_BASE, \
		 GSE_CSR_BUS_WRAP_SLV2_ERR)
#define LWIS_PLATFORM_EVENT_ID_GSE_SLV3_ERR \
	EVENT_ID(GSE_CSR_BUS_WRAP_BASE, \
		 GSE_CSR_BUS_WRAP_SLV3_ERR)
#define LWIS_PLATFORM_EVENT_ID_GSE_SLV4_ERR \
	EVENT_ID(GSE_CSR_BUS_WRAP_BASE, \
		 GSE_CSR_BUS_WRAP_SLV4_ERR)
#define LWIS_PLATFORM_EVENT_ID_GSE_SLV5_ERR \
	EVENT_ID(GSE_CSR_BUS_WRAP_BASE, \
		 GSE_CSR_BUS_WRAP_SLV5_ERR)
#define LWIS_PLATFORM_EVENT_ID_GSE_SLV6_ERR \
	EVENT_ID(GSE_CSR_BUS_WRAP_BASE, \
		 GSE_CSR_BUS_WRAP_SLV6_ERR)
#define LWIS_PLATFORM_EVENT_ID_GSE_SLV7_ERR \
	EVENT_ID(GSE_CSR_BUS_WRAP_BASE, \
		 GSE_CSR_BUS_WRAP_SLV7_ERR)
#define LWIS_PLATFORM_EVENT_ID_GSE_DEC_ERR \
	EVENT_ID(GSE_CSR_BUS_WRAP_BASE, \
