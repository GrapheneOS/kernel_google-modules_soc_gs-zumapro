...
#define PM_QOS_DSU_THROUGHPUT			(25)
#define PM_QOS_DSU_THROUGHPUT_MAX		(26)
#define PM_QOS_BCI_THROUGHPUT			(27)
#define PM_QOS_BCI_THROUGHPUT_MAX		(28)
#define EXYNOS_PM_QOS_NUM_CLASSES		(29)
