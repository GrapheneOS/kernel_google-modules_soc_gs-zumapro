...
export VENDOR_RAMDISK_BINARY=prebuilts/boot-artifacts/ramdisks/vendor_ramdisk-debug.img

: ${OUT_DIR:="out/"}
export OUT_DIR

: ${BUILD_CONFIG:="private/google-modules/soc/gs/build.config.zumapro_emulator"}
...
export CORE_GKI_FRAGMENT=private/google-modules/soc/gs/build.config.zumapro.gki.fragment
